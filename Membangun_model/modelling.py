...
def train_and_log_model(X_train, y_train, X_test, y_test, params, model_name="RandomForestClassifier"):
    ...
    # --- 1. Automatically Log Hyperparameters and Metrics ---
    mlflow.autolog()

    # Initialize the RandomForestClassifier with the provided parameters
    model = RandomForestClassifier(random_state=42, **params)

    # --- 2. Track Training Time (for manual logging in tuning script) ---
    ...
    # --- 4. Calculate specificity (for manual logging in tuning script) ---
